...
export const inspectionSchema = inspectionFields.superRefine((data, ctx) => {
...
/** Partial update — built from fields (Zod forbids .partial() on refined schemas). */
export const inspectionUpdateSchema = inspectionFields.partial();
